...
shared.LoaderTitle = "Đăng Ký Kênh Khoitongdz";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://1054865525308877",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=79719261171890";
v24.Parent = v23;
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://79719261171890") then
                    return v729;
                end
            end
        end
